...
class DishCatModel extends master_model_1.default {
    constructor() {
        super();
    }
    async fetch(params, limit = 1) {
        ...
        let query = 'SELECT * FROM orders.dish_category WHERE ';
        const values = [];
        let index = 1;
        try {
            // filter with res_id
...
exports.DishCatModel = DishCatModel;
