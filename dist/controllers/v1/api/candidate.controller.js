...
const candidate_model_1 = require("../../../models/v1/candidate.model");
class CandidateController extends master_controller_1.default {
    constructor() {
        super();
        this.candidateModel = new candidate_model_1.CandidateModel();
        // bindings
