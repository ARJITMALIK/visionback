...
const roles_model_1 = require("../../../../models/v1/hr/roles.model");
class RolesController extends master_controller_1.default {
    constructor() {
        super();
        this.rolesModel = new roles_model_1.RolesModel();
        // bindings
