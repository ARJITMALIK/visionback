...
const draw_model_1 = require("../../../models/v1/draw.model");
class DrawController extends master_controller_1.default {
    constructor() {
        super();
        this.drawModel = new draw_model_1.DrawModel();
        // bindings
