...
const election_model_1 = require("../../../models/v1/election.model");
class ElectionsController extends master_controller_1.default {
    constructor() {
        super();
        this.ElectionsModel = new election_model_1.ElectionModel();
        // bindings
